...
import (
	...
	handler "server/internal/app/adapters/primary/http-adapter/handlers/account"
	"testing"
...
func (m *mockAccountServiceS) CreateNewAccount(ctx context.Context, account *domain.Account) (int64, error) {
