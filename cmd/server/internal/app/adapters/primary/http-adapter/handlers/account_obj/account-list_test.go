...
import (
	...
	"server/internal/app/adapters/primary/http-adapter/handlers/account_obj"
	"testing"
...
func (m *mockAccountService) CreateNewAccountObj(ctx context.Context, account *domain.Account) (int64, error) {
