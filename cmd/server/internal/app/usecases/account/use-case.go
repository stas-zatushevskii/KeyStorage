...
func New(repo Repository) *Account {
	return &Account{repo: repo}
}

func (a *Account) GetAccountsList(ctx context.Context, userId int64) ([]*domain.Account, error) {
	if userId <= 0 {
...
func (a *Account) GetAccount(ctx context.Context, accountId int64) (*domain.Account, error) {
	if accountId <= 0 {
...
func (a *Account) CreateNewAccount(ctx context.Context, account *domain.Account) (int64, error) {
	if account.UserId <= 0 {
